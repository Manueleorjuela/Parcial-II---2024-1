...
private:
    ...
    bool Validacion_Linea_Conectar_Ya_Conectada(string &Nombre_Linea, int Case, Linea &Linea, int& Posicion_Estacion);
    bool Validacion_Conexiones(string *&Actualizacion);
    ...
    void Agregar_Linea_A_Conectadas(string &Nombre_Linea_Actual, string &Nombre_Linea_Conectar, int Case);
    void Mostrar_Lineas();
